    ...
    public function index(Request $request, SquareConnector $square, ToastConnector $toast): JsonResponse
    {
        ...
        return response()->json(['data' => [
            ...
            'providers' => [
                ...
                ['id' => 'toast', 'name' => 'Toast POS', 'availability' => $toast->configured() ? 'available' : 'partner setup required', 'configured' => $toast->configured(), 'description' => 'Connect each Toast restaurant location using its B Reviews location code. Completed checks are imported as visits; contact data never implies messaging consent.'],
