...
#[Fillable(['business_id', 'automation_dispatch_id', 'customer_id', 'message_template_id', 'review_link_id', 'generated_media_id', 'provider', 'channel', 'to_hash', 'to_last_four', 'provider_message_sid', 'status', 'provider_error_code', 'failure_message', 'queued_at', 'sent_at', 'delivered_at', 'failed_at'])]
