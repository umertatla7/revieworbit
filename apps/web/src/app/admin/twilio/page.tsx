...
export default function AdminTwilioPage() {
  ...
  return <div className="mx-auto max-w-6xl">
    <header className="border-b border-ink/8 pb-6">
      ...
      <p className="page-intro">Connect the B Reviews-owned Twilio account once. Credentials are encrypted and never shown again; each customer workspace then uses its own Messaging Service.</p>
    </header>
    ...
    <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
      <form key={setting?.account_sid ?? "new"} action={save} className="panel space-y-5">
        ...
        <label className="label">Auth Token
          ...
          <span className="mt-2 block text-xs font-normal text-ink/45">B Reviews requires the Auth Token for signed webhooks and parent-account access. It is encrypted at rest and never returned to the browser.</span>
        </label>
