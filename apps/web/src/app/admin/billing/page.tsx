...
type Plan = {
  ...
  media_template_limit: number; review_destination_limit: number; included_message_credits: number; overage_price_minor: number;
...
const numericFields = ["monthly_price_minor", "location_limit", "template_limit", "automation_limit", "automation_step_limit", "media_template_limit", "review_destination_limit", "included_message_credits", "overage_price_minor", "estimated_sms_provider_cost_minor", "estimated_mms_provider_cost_minor", "estimated_whatsapp_provider_cost_minor"] as const;
