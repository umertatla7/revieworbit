...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("revieworbit:support-expired", supportExpired);
  }, [router]);
  ...
  const workspace =
    supportBusiness ??
    user?.businesses.find((business) => business.id === selectedBusinessId())
      ?.name ??
